...
class FerreteriaUI:
    ...
    def create_control_panel(self, parent):
        ...
        buttons = [
            ...
            ("🔍 Extraer Datos HTML", self.app.extract_data),            ("🤖 Analizar con IA", self.app.analyze_with_ai),
        ...
        config_frame.grid(row=1, column=0, columnspan=5, pady=(10, 0), sticky=(tk.W, tk.E))
        
        # Botones de configuración
        config_buttons = [
            ("🔑 Configurar API Key", self.app.configure_api_key),
            ("📝 Personalizar Prompt", self.app.configure_custom_prompt)
        ]
        ...
        self.dir_label = ttk.Label(control_frame, text="Ningún directorio seleccionado", 
                                  foreground="gray")
        self.dir_label.grid(row=2, column=0, columnspan=5, pady=(10, 0))
